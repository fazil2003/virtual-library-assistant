...
def send_mail(user_mail,book_id):
    ...
    fromaddr = "fazilfazil462003@gmail.com"
    toaddr = user_mail
    ...
    BOOK ID = {0}
    <img src='http://ecampus.psgpolytech.ac.in/studzone/(S(jst4jbu2fp4qu5hyjsw5r5zg))/Images/psgtechlogo.jpg' />""".format(book_id)
