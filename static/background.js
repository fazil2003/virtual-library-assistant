...
$this.object = $("<div style='z-index:-1;margin:0;padding:0; overflow:hidden;position:fixed;bottom:0' id='"+$this.id+"'> </div>'").appendTo("#body_background");
...
$("#body_background").prepend("<style>.shape_background {transform-origin:center; width:80px; height:80px; background: "+$this.style.bubbles_color+"; position:fixed}</style>");
